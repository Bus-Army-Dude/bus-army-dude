document.addEventListener('DOMContentLoaded', function() {
    ...
    const newProductData = [
        { name: 'Product 1', price: '$29.99', imgSrc: 'product1.jpg', description: 'Product description goes here.', category: 'T-shirts' },
        { name: 'Product 2', price: '$39.99', imgSrc: 'product2.jpg', description: 'Product description goes here.', category: 'Hats' },
        { name: 'Product 3', price: '$19.99', imgSrc: 'product3.jpg', description: 'Product description goes here.', category: 'Accessories' },
        // Add more products as needed
    ];

    const productGrid = document.querySelector('.product-grid');

    // Dynamically add products to the grid
