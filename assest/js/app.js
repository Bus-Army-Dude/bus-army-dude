...
                        </div>
                        <a href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" aria-label="${name} weather" data-search-toggler data-lat="${lat}" data-lon="${lon}"></a>
                    `;
...
                    localStorage.setItem('weatherCity', JSON.stringify({ lat, lon }));
                })
            });
