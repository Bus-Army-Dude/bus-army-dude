...
const tiktokShoutouts = {
    accounts: [
        ...
        { username: 'badge502', isVerified: false, followers: '805.1K', nickname: 'Badge502', bio: 'NREMT - 911/EMD PO Box 775 Belleville, NJ 07109 *I DONT HAVE A BACKUP ACCOUNT*', profilePic: 'images/badge502.jpeg' },
    ...
    shoutoutSection: {
        lastUpdatedTime: '2025-02-08T09:04:24Z',
        init() {
        ...
        setLastUpdatedTime() {
            ...
            const utcDate = new Date(this.lastUpdatedTime);
...
tiktokShoutouts.shoutoutSection.init();
...
const instagramShoutouts = {
    accounts: [
        ...
        { username: 'applesauceandadhd', isVerified: true, followers: '774K', nickname: 'Jessica', bio: 'TeamJessSecrest@Gersh.com', profilePic: 'instagram_photos/applesauceandadhd.jpeg' },    
        ...
        { username: 'lisa.remillard', isVerified: true, followers: '107K', nickname: 'Lisa Remillard', bio: 'Public figure 📹 🎙Journalist, ▶️ Subcribe to my YouTube channel (@LisaRemillardOfficial)', profilePic: 'instagram_photos/lisaremillard.jpg' },                            
...
instagramShoutouts.shoutoutSection.init();
    ...
    shoutoutSection: {
        ...
        createShoutoutCards() {
            ...
            this.accounts.forEach(account => {
                ...
                card.className = 'creator-card';
                card.innerHTML = `
                    <img src="${account.profilePic}" alt="${account.nickname}" class="creator-pic" onerror="this.src='images/default-profile.jpg'">
                    <div class="creator-info">
                        <div class="creator-header">
                            <h3>${account.nickname}</h3>
                            ${account.isVerified ? '<img src="check.png" alt="Verified" class="verified-badge">' : ''}
                        ...
                        <p class="creator-bio">${account.bio || ''}</p>
                        <p class="follower-count">${account.followers} Followers</p>
                        <a href="https://youtube.com/${account.username}" target="_blank" class="visit-profile">
                            Visit Profile
                        </a>
                    </div>
                `;
        ...
        setLastUpdatedTime() {
            const lastUpdatedElement = document.getElementById('youtube-last-updated-timestamp');
            if (!lastUpdatedElement) return;
...
youtubeShoutouts.shoutoutSection.init();
