document.addEventListener('DOMContentLoaded', () => {
    ...
    const tiktokShoutouts = {
        accounts: [
            ...
            { username: 'mrfatcheeto', isVerified: false, followers: '462.2K', nickname: 'Mr Fat Cheeto', bio: 'OH YEAH!', profilePic: 'images/mrfatcheeto.jpeg' },
            ...
            { username: 'badge502', isVerified: false, followers: '798.6K', nickname: 'Badge502', bio: 'NREMT - 911/EMD PO Box 775 Belleville, NJ 07109 *I DONT HAVE A BACKUP ACCOUNT*', profilePic: 'images/badge502.jpeg' },
...
const lastUpdatedTime = "1:47 PM";    // Set the time here (12-hour format)
