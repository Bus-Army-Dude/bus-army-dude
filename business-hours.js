document.addEventListener("DOMContentLoaded", function () {
    ...
    const temporaryHours = {
        ...
        "2025-04-03": [
            { from: "10:25 AM", to: "10:40 AM", reason: "In a meeting" },
            { from: "12:00 PM", to: "1:00 PM", reason: "Busy" }
        ],
        "2025-04-04": [
            { from: "10:00 AM", to: "12:00 PM", reason: "In a meeting" }
        ],
        "2025-04-05": [
            { from: "6:00 PM", to: "8:00 PM", reason: "Eating Dinner" }
        ],
        "2025-04-07": [ 
            { from: "10:00 AM", to: "11:00 AM", reason: "In a meeting" }
        ],
        "2025-04-08": [ 
            { from: "10:30 AM", to: "11:00 AM", reason: "In a meeting" }
        ],
        "2025-04-09": [ 
        ...
        "2025-04-15": [ 
            { from: "10:00 AM", to: "12:30 PM", reason: "Out Of office" }
        ],
        "2025-04-16": [ 
            { from: "10:30 AM", to: "1:00 PM", reason: "Out Of office" },
            { from: "2:00 PM", to: "3:30 PM", reason: "Out Of office" }
        ]
    };
